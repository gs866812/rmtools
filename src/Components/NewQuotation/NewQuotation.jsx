...
const NewQuotation = () => {
  ...
  const handleSalesProduct = (e) => {
    ...
    const salesQuantity = parseFloat(parseFloat(form.purchase_quantity.value).toFixed(2));
    const salesUnit = unit;
    const salesPrice = parseFloat(parseFloat(form.sales_price.value).toFixed(2));
                ...
                {Array.isArray(tempProductList) ? (
                  tempProductList.map((product, i) => (
                    <tr key={i}>
                      ...
                      <td className="w-[10%]">{parseFloat(product.salesQuantity).toFixed(2)}</td>
                      <td className="w-[10%]">{product.salesUnit}</td>
                      <td className="w-[10%]">{parseFloat(product.salesPrice).toFixed(2)}</td>
                      <td className="w-[10%]">
                        {parseFloat(parseFloat(product.salesPrice * product.salesQuantity).toFixed(2))}
                      </td>
