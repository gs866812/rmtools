...
const SingleSupplierLedger = () => {
  ...
  return (
    <div className="px-2">
      <h2 className="text-2xl mt-5 font-bold uppercase">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    {singleSupplier.supplierAddress}-
                    <span className="border p-1 rounded-full">
                      {singleSupplier.supplierSerial}
                    </span>
                  </td>
                </tr>
                <tr>
              ...
              filteredPurchaseHistory.map((purchase) => (
                <tr key={purchase.invoiceNumber}>
                  ...
                  <td className="text-center w-[8%]">
                    {" "}
                    <IoEyeOutline
                      onClick={() => viewInvoice(purchase.invoiceNumber)}
        ...
        <div className="flex justify-center my-4">
          <div className="btn-group">
            ...
            <button
              ...
              onClick={() =>
                setCurrentPage((prev) =>
                  Math.min(prev + 1, singleSupplier.totalPages)
                )
              }
      ...
      <dialog id="paymentHistory" className="modal">
        <div className="modal-box w-2/4 max-w-5xl">
          <h3 className="font-bold text-lg mb-3 uppercase">Payment history:</h3>
          <hr />
          <form method="dialog">
            {/* if there is a button in form, it will close the modal */}
            <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2 text-white bg-red-400 hover:bg-red-500">
