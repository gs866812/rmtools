...
const AddBalance = () => {
  ...
  return (
    <>
      <button
        onClick={() => document.getElementById("AddNewBalance").showModal()}
        className="bg-[#48514C] text-white py-1 px-3 rounded-md"
      >
        + Add Balance
      </button>
      ...
      <dialog id="AddNewBalance" className="modal">
        <div className="modal-box">
          <h3 className="font-bold text-lg mb-3 uppercase">Add Balance:</h3>
          <hr />
          <form method="dialog">
