...
const AddProduct = () => {
  ...
  const { categories, brands, units, reFetch, setReFetch } =
  ...
  return (
    <div>
      <div
        className="text-white font-semibold text-xl cursor-pointer flex gap-2 items-center py-2 px-10"
                ...
                <div className=" space-y-5 flex-grow">
                  <p>
                    <input
                      ...
                      className="border p-1 w-full max-w-xs rounded-md outline-none"
                      size="30"
                      required
                    />
                  </p>
                  <p>
                    <select
                      className="border w-full max-w-xs rounded-md p-1 outline-none"
                      id="category"
                  ...
                  <p>
                    ...
                    >
                      ...
                      {Array.isArray(units)
                        ? units.map((unit) => (
                            <option key={unit._id}>{unit.unit}</option>
                          ))
                        : []}
                    </select>
                  </p>
