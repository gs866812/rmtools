          ...
          <div className="modal-box">
            ...
            <form onSubmit={handleAddSupplier} className="mt-5 space-y-3">
              ...
              <span className="flex items-start justify-end gap-3">
                ...
                <button className={`bg-green-500 py-2 px-4 rounded-md text-white hover:bg-green-600 cursor-pointer ${isLoading ? "opacity-50 cursor-not-allowed" : ""}`}
                disabled={isLoading}
                >
                  Add supplier
                </button>
